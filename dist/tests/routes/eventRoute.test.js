...
describe("TESTING THE EVENT ROUTES", () => {
    (0, globals_1.it)("SHOULD TEST THAT ORDINARY USER CAN NOT CREATE EVENT", () => __awaiter(void 0, void 0, void 0, function* () {
        //REGISTER USER
        const registerUserResponse = yield (0, supertest_1.default)(App_1.default)
        ...
        const createEventResponse = yield (0, supertest_1.default)(App_1.default)
            .post("/api/v1/event/createEvent")
            .send(mockdata_1.eventData);
